...
#define MOTOR_A_IN1 1  // Direction pin 1 for Motor A
#define MOTOR_A_IN2 2  // Direction pin 2 for Motor A
#define MOTOR_B_EN 3    // Enable pin for Motor B (must be PWM)
#define MOTOR_B_IN1 12   // Direction pin 1 for Motor B (was in3 in your code)
#define MOTOR_B_IN2 13   // Direction pin 2 for Motor B (was in4 in your code)
